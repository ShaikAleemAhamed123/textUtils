...
export default function TextArea(props) {
  ...
  return (
    ...
    <div>
        <div>
        <h3 id="textHead">Enter text to Process....</h3>
        <textarea value={text}  onChange={handleOnchange} placeholder='Enter text here.....' id="texrea" cols="100" rows="10"></textarea>
      </div>
...
<p> <b>Words:</b><i><b>{noOfWords}</b></i> </p>
<p><b>Characters:</b> <i><b>{text.length}</b></i> </p>
<p><b>Estimated Reading time:</b> <i><b>{0.008 * text.split(" ").length} mins</b></i> </p>
